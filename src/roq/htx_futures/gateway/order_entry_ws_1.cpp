...
OrderEntryWS1::OrderEntryWS1(OrderEntry::Handler &handler, io::Context &context, uint16_t stream_id, Account &account, Shared &shared)
...
void OrderEntryWS1::operator()(metrics::Writer &writer) const {
  writer
      // counter
...
uint16_t OrderEntryWS1::operator()(
...
uint16_t OrderEntryWS1::operator()(Event<CancelAllOrders> const &event, std::string_view const &request_id) {
...
void OrderEntryWS1::operator()(web::socket::Client::Connected const &) {
}

void OrderEntryWS1::operator()(web::socket::Client::Disconnected const &) {
  ++counter_.disconnect;
  (*this)(ConnectionStatus::DISCONNECTED);
}

void OrderEntryWS1::operator()(web::socket::Client::Ready const &) {
  send_login();
  // (*this)(ConnectionStatus::LOGIN_SENT);
  (*this)(ConnectionStatus::READY);
}

void OrderEntryWS1::operator()(web::socket::Client::Close const &) {
}

void OrderEntryWS1::operator()(web::socket::Client::Latency const &latency) {
...
void OrderEntryWS1::operator()(web::socket::Client::Text const &) {
  log::fatal("Unexpected"sv);
}

void OrderEntryWS1::operator()(web::socket::Client::Binary const &binary) {
...
void OrderEntryWS1::operator()(ConnectionStatus connection_status, std::string_view const &reason) {
...
void OrderEntryWS1::send_pong(std::chrono::milliseconds timestamp) {
...
void OrderEntryWS1::parse(std::string_view const &message) {
...
void OrderEntryWS1::operator()(Trace<protocol::json::Close2> const &) {
  profile_.close([&]() {
...
void OrderEntryWS1::operator()(Trace<protocol::json::Error2> const &event) {
  profile_.error([&]() {
...
void OrderEntryWS1::operator()(Trace<protocol::json::Ping> const &event) {
  profile_.ping([&]() {
...
void OrderEntryWS1::operator()(Trace<protocol::json::Auth> const &event) {
  profile_.auth([&]() {
...
void OrderEntryWS1::operator()(Trace<protocol::json::Response> const &event) {
