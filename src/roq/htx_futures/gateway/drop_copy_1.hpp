...
struct DropCopy1 final : public DropCopy, public web::socket::Client::Handler, public protocol::json::Parser2::Handler {
  DropCopy1(DropCopy::Handler &, io::Context &, uint16_t stream_id, Account &, Shared &);

  DropCopy1(DropCopy const &) = delete;
