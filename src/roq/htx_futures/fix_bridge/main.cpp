...
#include "roq/htx_futures/fix_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's HTX futures gateway (FIX interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::htx_futures::fix_bridge::Application{args, settings, INFO}.run();
}
