...
#include "roq/htx_futures/protocol/json/frame.hpp"
#include "roq/htx_futures/protocol/json/topic.hpp"
      ...
      case UNDEFINED_INTERNAL: {
        ...
        switch (topic) {
          ...
          case UNKNOWN_INTERNAL:
            ...
            break;
          case BBO:
            dispatch_helper<protocol::json::BBO>(handler, message, buffer_stack, trace_info);
            return true;
          case DEPTH:
